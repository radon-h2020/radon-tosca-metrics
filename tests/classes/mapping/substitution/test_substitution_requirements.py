...
@parameterized_class([
   ...
   { 'input': {'requirement':RequirementMapping()},  'expected': False},
   { 'input': {'requirement_1':RequirementMapping(), 'requirement_2':1},  'expected': True},
...
class TestSubstitutionMappingCapabilities(unittest.TestCase):
    ...
    def test(self):
        ...
        try:
            SubstitutionMapping(nodeType='test', requirements=self.input)
        except TypeError:
            raised = True
        finally:
