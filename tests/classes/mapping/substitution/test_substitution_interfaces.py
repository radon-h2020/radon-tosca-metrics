...
@parameterized_class([
   ...
   { 'input': {'interface':InterfaceMapping()},  'expected': False},
   { 'input': {'interface_1':InterfaceMapping(), 'interface_2':1},  'expected': True},
...
class TestSubstitutionMappingCapabilities(unittest.TestCase):
    ...
    def test(self):
        ...
        try:
            SubstitutionMapping(nodeType='test', interfaces=self.input)
        except TypeError:
            raised = True
        finally:
